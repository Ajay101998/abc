...
import { ShopingFormService } from 'src/app/services/shoping-form.service';
...
export class CheckoutComponent implements OnInit{
  ...
  constructor(private formBuilder: FormBuilder,
              private shopFormService: ShopingFormService,
  ...
  getStates(formGroupName: string){
    ...
    console.log(`{formGoupName} country code: ${countryCode}`);
